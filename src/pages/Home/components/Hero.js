  ...
  return (
    <section className="flex flex-col lg:flex-row dark:text-slate-100 items-center">
      <div className="text my-5">
        <h1 className="text-5xl font-bold">The Ultimate eCode Store</h1>
        <p className="text-2xl my-7 px-1 dark:text-slate-300">
          CodeVault is the leading platform for the most trusted and
          comprehensive programming courses. Explore top-rated content and gain
          access to the latest courses online.
        </p>
        <Link
          to="/products"
          type="button"
